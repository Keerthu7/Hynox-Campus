      ...
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 20px auto; padding: 30px; border: 1px solid #e2e8f0; border-radius: 12px; background-color: #ffffff;">
          ...
          <table style="width: 100%; border-collapse: collapse;">
            <tr><td style="padding: 10px 0; color: #64748b; font-weight: bold; width: 140px;">Full Name</td><td style="padding: 10px 0; color: #0f172a;">${fullname}</td></tr>
            <tr><td style="padding: 10px 0; color: #64748b; font-weight: bold;">Email Address</td><td style="padding: 10px 0; color: #0f172a;">${email}</td></tr>
            <tr><td style="padding: 10px 0; color: #64748b; font-weight: bold;">Phone Number</td><td style="padding: 10px 0; color: #0f172a;">${phone}</td></tr>
            <tr><td style="padding: 10px 0; color: #64748b; font-weight: bold;">College Name</td><td style="padding: 10px 0; color: #0f172a;">${college}</td></tr>
            <tr><td style="padding: 10px 0; color: #64748b; font-weight: bold;">Year of Study</td><td style="padding: 10px 0; color: #0f172a;">${year}</td></tr>
            <tr><td style="padding: 10px 0; color: #64748b; font-weight: bold;">Preferred Domain</td><td style="padding: 10px 0; color: #0f172a;">${domain}</td></tr>
            <tr><td style="padding: 10px 0; color: #64748b; font-weight: bold;">Experience Level</td><td style="padding: 10px 0; color: #0f172a;">${experience}</td></tr>
            <tr style="background-color: #f8fafc;"><td style="padding: 10px; color: #00C365; font-weight: bold;">Selected Package</td><td style="padding: 10px; color: #0f172a; font-weight: bold;">${selectedPackage}</td></tr>
            <tr style="background-color: #f8fafc;"><td style="padding: 10px; color: #00C365; font-weight: bold;">UTR / Trans ID</td><td style="padding: 10px; color: #0f172a; font-weight: bold;">${utrNumber}</td></tr>
          </table>
          ${attachments.length > 0 ? `<p style="margin-top: 20px; color: #64748b; font-style: italic;">Note: A payment screenshot has been attached.</p>` : ''}
          <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e2e8f0; font-size: 12px; color: #94a3b8; text-align: center;">
            Submitted via the Hynox Campus workshop hub.
          </div>
        </div>
      `,
    })
      ...
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 20px auto; padding: 40px; border: 1px solid #e2e8f0; border-radius: 16px; background-color: #ffffff; color: #0F172A;">
          <div style="text-align: center; margin-bottom: 30px;">
            <div style="width: 60px; height: 60px; background-color: #00C365; border-radius: 50%; display: inline-block; padding: 15px; margin-bottom: 20px;">
          ...
          <p style="font-size: 14px; color: #94A3B8; margin-top: 30px; border-top: 1px solid #E2E8F0; padding-top: 20px; text-align: center;">
            Questions? Contact us at hello.hynoxcampus@gmail.com
          </p>
