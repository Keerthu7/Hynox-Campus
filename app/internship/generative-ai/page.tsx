...
const ACTS = [
  {
    ...
    description: "Deep dive into Generative AI, LLMs, Prompt Engineering, Retrieval-Augmented Generation (RAG), and building intelligent agents using Python & LangChain.",
  },
  {
    act: "Phase 2",
    ...
    description: "Hands-on experience working on live industry projects. Build production-ready AI applications, fine-tune models, and deploy scalable AI solutions.",
  }
];

const PROGRAM_DETAILS = [
  ["Duration",        "9 Months", "bg-[#00C365]/5"],
  ["Format",          "3 Months Training + 6 Months Projects", "bg-white"],
  ["Stack",           "Python, LangChain, OpenAI, React", "bg-[#00C365]/5"],
  ["Certification",   "Generative AI Engineer Intern", "bg-white"],
  ["Outcome",         "Industry-ready Portfolio & Experience", "bg-[#00C365]/5"],
];

// ── COMPONENT ────────────────────────────────────────────────────────────

const GenerativeAiInternship = () => {
  useEffect(() => {
  ...
  const handlePaymentComplete = async () => {
    ...
    if (pendingFormData) {
      ...
      const pkg = selectedOption === 'standard' ? 'Standard' : 'Premium'
      ...
      const data = {
        ...
        _subject: `New Internship Application: ${domain} - ${fullname}`,
        _template: "table",
        _captcha: "false"
      }
      ...
      <main className="relative z-10 flex-grow">
        ...
        <section className="pt-24 pb-12 px-4 flex items-center justify-center relative overflow-hidden bg-white">
          ...
          <div className="w-full max-w-4xl bg-[#0f111a] border border-slate-800 rounded-[28px] p-6 md:p-12 text-center relative shadow-2xl overflow-hidden" data-aos="zoom-in-up">
            <Link href="/internship" className="absolute top-6 left-6 flex items-center gap-2 text-slate-400 hover:text-[#00C365] transition-colors text-xs md:text-sm font-bold group/back font-poppins z-20">
            ...
            <div className="relative z-10 font-poppins pt-8 md:pt-0">
              <span className="text-[9px] md:text-[10px] font-bold tracking-[0.3em] text-[#00C365] uppercase mb-4 md:mb-6 block" data-aos="fade-up">Domain: Generative AI</span>
              <h1 className="text-[24px] md:text-[40px] font-bold text-white leading-[1.2] mb-4 md:mb-6">
                Become a <span className="text-[#00C365]">Generative AI Engineer</span>
              </h1>
              <p className="text-[#94a3b8] text-sm md:text-lg font-medium mb-8 md:mb-10 max-w-xl mx-auto" data-aos="fade-up" data-aos-delay="400">
                A 9-month immersive program: 3 months of core training followed by 6 months building real-world AI applications.
              </p>
              <div data-aos="fade-up" data-aos-delay="600" className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <button className="flex items-center justify-center gap-2 text-white font-bold text-sm md:text-base px-6 hover:text-[#00C365] transition-colors">
                  ...
                  <span>Watch Curriculum Video</span>
                </button>
              </div>
            </div>
          </div>
        ...
        <section className="py-12 bg-slate-50 relative overflow-hidden font-poppins">
          <div className="container mx-auto px-6 max-w-5xl relative z-10">
            <div className="text-center mb-8" data-aos="fade-up">
              <h2 className="text-xl md:text-2xl font-bold text-[#0F172A] mb-2">Internship Roadmap</h2>
              <p className="text-slate-500 text-sm md:text-base font-medium">Your 9-month journey to becoming an AI engineer.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 max-w-4xl mx-auto">
              {ACTS.map((a, i) => (
                <div
                  ...
                  className={`bg-white border-b-4 ${a.border} rounded-[20px] p-6 shadow-lg transition-all duration-500 hover:-translate-y-1`}
                >
                  <div className={`w-10 h-10 ${a.bg} ${a.color} rounded-lg flex items-center justify-center mb-4`}>
                    {a.icon}
                  </div>
                  <span className={`text-[10px] font-black uppercase tracking-widest ${a.color} block mb-2`}>{a.act}</span>
                  <h3 className="text-lg font-bold text-[#0F172A] mb-2">{a.title}</h3>
                  <span className={`inline-block px-2 py-1 rounded-full text-[10px] font-bold bg-slate-100 text-slate-600 mb-4`}>
                    {a.duration}
                  </span>
        ...
        <section className="py-12 bg-white font-poppins">
          <div className="container mx-auto px-6 max-w-xl">
            <h2 className="text-xl md:text-2xl font-bold text-[#0F172A] mb-6 text-center" data-aos="fade-up">Program <span className="text-[#00C365]">Details</span></h2>
        ...
        <section ref={formRef} id="apply-form" className="py-16 md:py-20 bg-white relative">
           <div className="container mx-auto px-4 md:px-6 max-w-4xl">
             <div className="text-center mb-8 md:mb-12" data-aos="fade-up">
               <h2 className="text-[26px] md:text-[36px] font-bold text-[#0F172A] mb-2 tracking-tight">Apply for the Internship</h2>
               <p className="text-slate-500 text-base md:text-lg font-medium">Fill in your details below to start your career journey</p>
             </div>
               ...
               {showPricing && (
                 <div className="absolute inset-0 z-[100] bg-white/95 backdrop-blur-md rounded-[24px] flex items-center justify-center p-4 md:p-8 animate-in fade-in zoom-in duration-300">
                    <div className="w-full max-w-lg">
                       <h3 className="text-lg md:text-xl font-bold text-center text-[#0F172A] mb-6">Select Your Enrollment Package</h3>
                       <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                          ...
                          >
                            ...
                            <div className="flex items-baseline gap-1 mb-3">
                               <span className="text-2xl font-black text-black">₹1999</span>
                            ...
                            <ul className="space-y-1.5 mb-4">
                               <li className="flex items-center gap-2 text-[11px] text-slate-600 font-medium">
                                 <CheckCircle className="w-3 h-3 text-[#00C365]" /> 9-Month Program
                               </li>
                               <li className="flex items-center gap-2 text-[11px] text-slate-600 font-medium">
                                 <CheckCircle className="w-3 h-3 text-[#00C365]" /> Project Reviews
                               </li>
                            </ul>
                          ...
                          >
                            ...
                            <h4 className="text-base font-bold text-white mb-1">Premium + Cert</h4>
                            <div className="flex items-baseline gap-1 mb-3">
                               <span className="text-2xl font-black text-[#00C365]">₹2999</span>
                            </div>
                            <ul className="space-y-1.5 mb-4">
                               ...
                               <li className="flex items-center gap-2 text-[11px] text-zinc-400 font-medium">
                                 <CheckCircle className="w-3 h-3 text-[#00C365]" /> Placement Assistance
                               </li>
                            </ul>
                         ...
                         <>
                           ...
                           <div className="bg-slate-50 border border-slate-100 p-4 rounded-xl mb-4 flex flex-col items-center">
                              ...
                              <div className="text-center w-full">
                                ...
                                <span className="text-xl font-black text-black font-poppins block mb-3">₹{selectedOption === 'standard' ? '1999' : '2999'}</span>
        ...
        <section className="py-20 md:py-24 bg-[#000000] px-4 text-center relative overflow-hidden">
          <div className="max-w-4xl mx-auto relative z-10" data-aos="fade-up">
            <h2 className="text-[28px] md:text-[42px] font-bold text-white leading-[1.1] mb-6 md:mb-8 tracking-tight">
              Kickstart Your AI Career <br className="hidden md:block" /> with Real Industry Projects
            </h2>
            <p className="text-zinc-400 text-sm md:text-lg font-medium mb-10 md:mb-12 max-w-2xl mx-auto leading-relaxed">
              Limited seats available for our comprehensive internship program. Master generative AI, build production-grade AI agents, and get industry-recognized certification.
            </p>
...
export default GenerativeAiInternship;
