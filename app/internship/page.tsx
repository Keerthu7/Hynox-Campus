...
import { Monitor, Server, Cpu, Database, Layout, Smartphone, ChevronRight } from "lucide-react"
import AOS from "aos"
...
const INTERNSHIPS = [
  {
    id: "genai",
    title: "Generative AI",
    link: "/internship/generative-ai",
    status: "OPEN",
    icon: <Cpu className="w-8 h-8 text-[#00C365]" />,
    description: "9 months internship: 3 months training & 6 months real-time projects."
  },
  {
    id: "fullstack",
    ...
    description: "End-to-end web apps with the MERN stack."
  },
  {
    id: "uiux",
    title: "UI/UX Design",
  ...
  },
  {
    ...
    description: "Create cross-platform apps with React Native or Flutter."
  },
]
        ...
        <section className="container mx-auto px-6 md:px-16 max-w-7xl">
          ...
          <div className="mb-10 text-left" data-aos="fade-up">
            ...
            <p className="text-slate-500 text-sm md:text-base font-medium max-w-xl leading-relaxed">
              Kickstart your career with immersive, real-world internships. Gain hands-on experience by building production-ready projects.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {INTERNSHIPS.map((internship, index) => {
              const isCardClickable = internship.status === "OPEN"
              ...
              return (
                <div key={internship.id} data-aos="fade-up" data-aos-delay={index * 100} className="h-full">
                  {isCardClickable ? (
                    <Link href={internship.link} className="block h-full">
                      {CardContent}
                    </Link>
                  ) : (
